...
<div class="container home-content">
   ...
   <div id="popular-downloads">
      ...
      <div class="row movie-list kb1">
         <?php $__currentLoopData = $moviesArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <div class="browse-movie-wrap col-xs-10 col-sm-5">
            <a href="movies/red-notice-2021.html" class="browse-movie-link">
               <figure>
                  <img class="img-responsive" src="<?php echo e($val['large_cover_image']); ?>" alt="Red Notice (2021) download" width="210" height="315" />
            ...
            <div class="browse-movie-bottom">
               <a href="movies/red-notice-2021.html" class="browse-movie-title"><?php echo e($val['title']); ?></a>
         ...
         <!-- <div class="browse-movie-wrap col-xs-10 col-sm-5">
            <a href="movies/shang-chi-and-the-legend-of-the-ten-rings-2021.html" class="browse-movie-link">
               <figure>
                  <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/shang_chi_and_the_legend_of_the_ten_rings_2021/medium-cover.jpg')); ?>" alt="Shang-Chi and the Legend of the Ten Rings (2021) download" width="210" height="315" />
                  <figcaption class="hidden-xs hidden-sm">
                     <span class="icon-star"></span>
         ...
         <div class="browse-movie-wrap col-xs-10 col-sm-5">
            <a href="movies/passing-2021.html" class="browse-movie-link">
               <figure>
                  <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/passing_2021/medium-cover.jpg')); ?>" alt="Passing (2021) download" width="210" height="315" />
                  <figcaption class="hidden-xs hidden-sm">
                     <span class="icon-star"></span>
         ...
         <div class="browse-movie-wrap col-xs-10 col-sm-5">
            <a href="movies/apex-2021.html" class="browse-movie-link">
               <figure>
                  <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/apex_2021/medium-cover.jpg')); ?>" alt="Apex (2021) download" width="210" height="315" />
                  <figcaption class="hidden-xs hidden-sm">
                     <span class="icon-star"></span>
             ...
             <?php $__currentLoopData = $moviesArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <div class="browse-movie-wrap col-xs-10 col-sm-5">
                  <a href="movies/conscience-point-2019.html" class="browse-movie-link">
                     <figure>
                        <img class="img-responsive" src="<?php echo e($val['large_cover_image']); ?>" alt="Conscience Point (2019) download" width="210" height="315" />
                     
                        <!-- <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/conscience_point_2019/medium-cover.jpg')); ?>" alt="Conscience Point (2019) download" width="210" height="315" /> -->
                        <!-- <img class="quality-banner img-responsive" src="<?php echo e(asset('front/assets/images/website/banner1080p.png')); ?>" alt="Conscience Point (2019) download 1080p" width="118" height="91"> -->
                        <figcaption class="hidden-xs hidden-sm">
                           <span class="icon-star"></span>
                  ...
                  <div class="browse-movie-bottom">
                     <a href="movies/conscience-point-2019.html" class="browse-movie-title"><?php echo e($val['title']); ?></a>
               ...
               <!-- <div class="browse-movie-wrap col-xs-10 col-sm-5">
                  <a href="movies/determination-of-death-2001.html" class="browse-movie-link">
                     <figure>
                        <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/determination_of_death_2001/medium-cover.jpg')); ?>" alt="Determination of Death (2001) download" width="210" height="315" />
                        <img class="quality-banner img-responsive" src="<?php echo e(asset('front/assets/images/website/banner720p.png')); ?>" alt="Determination of Death (2001) download 720p" width="118" height="91">
                        <figcaption class="hidden-xs hidden-sm">
                           <span class="icon-star"></span>
               ...
               <!-- <div class="browse-movie-wrap col-xs-10 col-sm-5">
                  <a href="movies/castle-of-owls-1963.html" class="browse-movie-link">
                     <figure>
                        <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/castle_of_owls_1963/medium-cover.jpg')); ?>" alt="Castle of Owls (1963) download" width="210" height="315" />
                        <img class="quality-banner img-responsive" src="<?php echo e(asset('front/assets/images/website/banner1080p.png')); ?>" alt="Castle of Owls (1963) download 1080p" width="118" height="91">
                        <figcaption class="hidden-xs hidden-sm">
                           <span class="icon-star"></span>
                           <h4 class="rating">6.6 / 10</h4>
                           <h4>Drama</h4>
               ...
               <!-- <div class="browse-movie-wrap col-xs-10 col-sm-5">
                  <a href="movies/perilous-2000.html" class="browse-movie-link">
                     <figure>
                        <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/perilous_2000/medium-cover.jpg')); ?>" alt="Perilous (2000) download" width="210" height="315" />
                        <img class="quality-banner img-responsive" src="<?php echo e(asset('front/assets/images/website/banner1080p.png')); ?>" alt="Perilous (2000) download 1080p" width="118" height="91">
                        <figcaption class="hidden-xs hidden-sm">
                           <span class="icon-star"></span>
            ...
            <!-- <div class="row">
               <div class="browse-movie-wrap col-xs-10 col-sm-5">
                  <a href="movies/the-heart-of-the-matter-1953.html" class="browse-movie-link">
                     <figure>
                        <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/the_heart_of_the_matter_1953/medium-cover.jpg')); ?>" alt="The Heart of the Matter (1953) download" width="210" height="315" />
                        <img class="quality-banner img-responsive" src="<?php echo e(asset('front/assets/images/website/banner720p.png')); ?>" alt="The Heart of the Matter (1953) download 720p" width="118" height="91">
                        <figcaption class="hidden-xs hidden-sm">
                           <span class="icon-star"></span>
               ...
               <!-- <div class="browse-movie-wrap col-xs-10 col-sm-5">
                  <a href="movies/the-book-of-vision-2020.html" class="browse-movie-link">
                     <figure>
                        <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/the_book_of_vision_2020/medium-cover.jpg')); ?>" alt="The Book of Vision (2020) download" width="210" height="315" />
                        <img class="quality-banner img-responsive" src="<?php echo e(asset('front/assets/images/website/banner1080p.png')); ?>" alt="The Book of Vision (2020) download 1080p" width="118" height="91">
                        <figcaption class="hidden-xs hidden-sm">
                           <span class="icon-star"></span>
               ...
               <!-- <div class="browse-movie-wrap col-xs-10 col-sm-5">
                  <a href="movies/maximum-achievement-the-brian-tracy-story-2017.html" class="browse-movie-link">
                     <figure>
                        <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/maximum_achievement_the_brian_tracy_story_2017/medium-cover.jpg')); ?>" alt="Maximum Achievement: The Brian Tracy Story (2017) download" width="210" height="315" />
                        <img class="quality-banner img-responsive" src="<?php echo e(asset('front/assets/images/website/banner1080p.png')); ?>" alt="Maximum Achievement: The Brian Tracy Story (2017) download 1080p" width="118" height="91">
                        <figcaption class="hidden-xs hidden-sm">
                           <span class="icon-star"></span>
               ...
               <!-- <div class="browse-movie-wrap col-xs-10 col-sm-5">
                  <a href="movies/fling-2008.html" class="browse-movie-link">
                     <figure>
                        <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/fling_2008/medium-cover.jpg')); ?>" alt="Fling (2008) download" width="210" height="315" />
                        <img class="quality-banner img-responsive" src="<?php echo e(asset('front/assets/images/website/banner1080p.png')); ?>" alt="Fling (2008) download 1080p" width="118" height="91">
                        <figcaption class="hidden-xs hidden-sm">
                           <span class="icon-star"></span>
         ...
         <div class="row">
            <div class="browse-movie-wrap col-xs-10 col-sm-5">
               <a href="https://www.imdb.com/title/tt3331846/" target="_blank" class="browse-movie-link">
                  <figure>
                     <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/stand_by_me_doraemon_2014/medium-cover.jpg')); ?>" alt="Stand by Me Doraemon (2014)" width="210" height="315" />
            ...
            <div class="browse-movie-wrap col-xs-10 col-sm-5">
               <a href="https://www.imdb.com/title/tt0083352/" target="_blank" class="browse-movie-link">
                  <figure>
                     <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/dreadnaught_1981/medium-cover.jpg')); ?>" alt="Dreadnaught (1981)" width="210" height="315" />
                     <figcaption class="hidden-xs hidden-sm imdb-upcoming">
                        <span class="button-green-download2-big button-yellow-download-big">View IMDb</span>
                     </figcaption>
                  </figure>
            ...
            <div class="browse-movie-wrap col-xs-10 col-sm-5">
               <a href="movies/no-time-to-die-2021.html" class="browse-movie-link">
                  <figure>
                     <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/no_time_to_die_2021/medium-cover.jpg')); ?>" alt="No Time to Die (2021)" width="210" height="315" />
                     <figcaption class="hidden-xs hidden-sm">
                        <span class="icon-star"></span>
            ...
            <div class="browse-movie-wrap col-xs-10 col-sm-5">
               <a href="movies/the-heart-of-the-matter-1953.html" class="browse-movie-link">
                  <figure>
                     <img class="img-responsive" src="<?php echo e(asset('front/img.yts.mx/assets/images/movies/the_heart_of_the_matter_1953/medium-cover.jpg')); ?>" alt="The Heart of the Matter (1953)" width="210" height="315" />
                     <figcaption class="hidden-xs hidden-sm">
                        <span class="icon-star"></span>
                        <h4 class="rating">6.8 / 10</h4>
                        <h4>Drama</h4>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MoviesProject\resources\views/pages/home.blade.php ENDPATH**/ ?>