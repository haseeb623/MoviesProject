...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/adele_one_night_only_2021/medium-cover.jpg')}}" alt="Adele One Night Only (2021) download" width="170" height="255">
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/home_sweet_home_alone_2021/medium-cover.jpg')}}" alt="Home Sweet Home Alone (2021) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/one_shot_2021/medium-cover.jpg')}}" alt="One Shot (2021) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/american_night_2021/medium-cover.jpg')}}" alt="American Night (2021) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/sukkubus_1989/medium-cover.jpg')}}" alt="Sukkubus (1989) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/ciao_alberto_2021/medium-cover.jpg')}}" alt="Ciao Alberto (2021) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/next_stop_christmas_2021/medium-cover.jpg')}}" alt="Next Stop, Christmas (2021) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/jfk_revisited_through_the_looking_glass_2021/medium-cover.jpg')}}" alt="JFK Revisited: Through the Looking Glass (2021) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/hotel_coolgardie_2016/medium-cover.jpg')}}" alt="Hotel Coolgardie (2016) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/the_transformers_the_movie_1986/medium-cover.jpg')}}" alt="The Transformers: The Movie (1986) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
...
<figure>
<img class="img-responsive" src="{{asset('front/img.yts.mx/assets/images/movies/the_guns_of_navarone_1961/medium-cover.jpg')}}" alt="The Guns of Navarone (1961) download" width="170" height="255">
<figcaption class="hidden-xs hidden-sm">
<span class="icon-star"></span>
